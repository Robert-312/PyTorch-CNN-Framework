...
class CustomPneumoniaNN(nn.Module):
    def __init__(self, out_channels=1, image_size=(320, 320)):
        super(CustomPneumoniaNN, self).__init__()
        self.pool = nn.MaxPool2d(2, 2)
        self.softmax = nn.Softmax(dim=1)
        self.out_channels = out_channels
        
        self.post_pooling_width = int(image_size[0] / 8)  # pooling reduces by 1/2 and is done 4 times = 8
        self.post_pooling_height = int(image_size[1] / 8)
        ...
        #relu
        #max pool 2x2 This will make image size 160x160 (320x320 input)
        ...
        #relu
        #max pool 2x2 This will make image size 80/80 (320x320 input)
        ...
        #relu
        #max pool 2x2 This will make image size 40/40 (320x320 input)
        ...
        self.flattened_length_ = 64 * self.post_pooling_width * self.post_pooling_height # (64*40*40 for 320x320 input image)
        ...
        # m=1024x(64*40*40), b=1024 = 1024x64x40x40 + 1024 = 104,858,624 trainable parameters (320x320)
        # m=1024x(64*28*28), b=1024 = 1024x64x28x28 + 1024 = 51,381,248 trainable parameters (224x224)
